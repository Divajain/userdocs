...
Salesforce provide details of this process [here](https://help.salesforce.com/articleView?id=adding_fields.htm&type=5). If you are unsure of this process you may wish to obtain assistance from a certified Salesforce consultant.

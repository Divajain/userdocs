...
![Asperato standard payment template](/img/unmodified_template.png "Asperato standard template")
...
Parameters may be passed to the payment page via URL parameters. Passing parameters in the URL is often useful for testing purposes.
...
`https://test.protectedpayments.net/PMWeb1?pmRef=903&pid=7010Y000000DTD1`

Then the email can be pre-populated to `test@asperato.com` with the following URL:

`https://test.protectedpayments.net/PMWeb1?pmRef=903&pid=7010Y000000DTD1&DLemail=test@asperato.com`
...
This will set the payment frequency (one of "Single", "Daily", "Weekly", "Monthly", "Quarterly", "Semi-annual" or "Annual")

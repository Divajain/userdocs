    ...
    return (
      <SplashContainer>
        <div className="inner">
          ...
          <p className="paraText">
            <strong>Haven't yet got the package? <a target="_blank" href="https://appexchange.salesforce.com/appxListingDetail?listingId=a0N3A00000EcrOnUAJ">Install it from the AppExchange here.</a></strong>
          </p>
          <p className="paraText">
